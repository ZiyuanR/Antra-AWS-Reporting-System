...
import com.antra.report.client.handler.BackendAdapter;
...
public class EmailServiceImpl implements EmailService{
    ...
    public EmailServiceImpl(QueueMessagingTemplate queueMessagingTemplate, BackendAdapter backendAdapter) {
    ...
    public void sendEmail(String to, EmailType success, String submitter) {
        ...
        try {
        	...
        	backendAdapter.getBackendResponse(simulateretry, simulateretryfallback);
        }
